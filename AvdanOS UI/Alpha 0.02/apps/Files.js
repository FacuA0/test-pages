function FilesApp() {
	...
	this.mouseExit = (event) => {
		for (e of this.mainFavoritesHover) this.mainFavoritesHover[e] = false;
		for (e of this.mainPinnedHover) this.mainPinnedHover[e] = false;
		for (e of this.mainTagsHover) this.mainTagsHover[e] = false;
		for (e of this.hoverFiles) this.hoverFiles[e] = false;
		for (e in this.hoverSidebar) e = false;
		this.hoverForward = false;
		this.hoverBack = false;
